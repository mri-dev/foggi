    ...
    <div class="row np">
        <form action="#basics" method="post">
            <div class="con">
                ...
                <div class="row np">
                    <div class="col-md-12">
                        <label for="basics_blog_url">BLOG elérhetősége</label>
                        <input type="text" id="basics_blog_url" name="blog_url" class="form-control" value="<?=$this->settings['blog_url']?>">
                    </div>
                </div>
                <br>
                <div class="row np">
                ...
                <div class="row np">
                    <div class="col-md-12">
                        <label for="basics_BLOG_URL_ABOUT">"Bemutatkozás" elérhetősége</label>
                        <input type="text" id="basics_BLOG_URL_ABOUT" name="BLOG_URL_ABOUT" class="form-control" value="<?=$this->settings['BLOG_URL_ABOUT']?>">
                    </div>
                </div>
                <br>
                <div class="row np">
                    <div class="col-md-12">
                        <label for="basics_BLOG_URL_CONTACT">"Kapcsolat" oldal elérhetősége</label>
                        <input type="text" id="basics_BLOG_URL_CONTACT" name="BLOG_URL_CONTACT" class="form-control" value="<?=$this->settings['BLOG_URL_CONTACT']?>">
                    </div>
                </div>
                ...
                <div class="row np">
                    <div class="col-md-12">
                        <label for="basics_stock_orderallow">Készlet és állapot szerinti értékesítés</label>
                        <select name="stock_orderallow" id="basics_stock_orderallow" class="form-control">
                            <option value="0" <?=($this->settings['stock_orderallow'] == '0' ? 'selected="selected"' : '')?>>Nem</option>
                            <option value="1" <?=($this->settings['stock_orderallow'] == '1' ? 'selected="selected"' : '')?>>Igen</option>
                        </select>
                    </div>
                </div>
                <br>
                ...
                <div class="row np">
                    ...
                    <div class="col-md-3" style="padding-left:8px;display:none;">
