					...
					<div class="row">
						<div>
							<div class="col-sm-6">
								...
								<input type="text" id="coupon_code" name="coupon_code" value="<?=(isset($_POST[coupon_code])) ? $_POST[coupon_code] : 'FOGGI-'.date('Y').'-'.strtoupper(strrev(uniqid()))?>" class="form-control">
