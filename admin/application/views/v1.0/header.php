...
<body class="<? if(!$this->adm->logged): ?>blured-bg<? else: ?>logged-in<? endif; ?>">
<div id="top" class="container-fluid">
	<div class="row">
		<? if(!$this->adm->logged): ?>
		<div class="col-md-12 center"><img height="34" src="<?=IMG?>foggi_logo_white_vector.svg" alt="<?=TITLE?>"></div>
		<? else: ?>
    	<div class="col-md-7 left">
    		<img height="34" class="top-logo" src="<?=IMG?>foggi_logo_white_vector.svg" alt="<?=TITLE?>">
    		<div class="link">
    			<a href="<?=HOMEDOMAIN?>" target="_blank">www.<?=str_replace(array('http://','www'), '', $this->settings['page_url'])?></a>
    		</div>
    	</div>
	...
	<div class="row">
	    <div class="bg col-md-4 col-md-offset-4">
            ...
            <form action="" method="post">
                ...
                <br>
                <div class="left links"><a href="<?=HOMEDOMAIN?>"><i class="fa fa-angle-left"></i> www.<?=str_replace(array('http://','www'), '', $this->settings['page_url'])?></a></div>
