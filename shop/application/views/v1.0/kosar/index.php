						...
						<div class="p10 cart-head">
							...
							<div style="float:right;">
								<? if($this->gets[1] == '' || $this->gets[1] == '0'): ?>
									<a href="/kosar/?clear=1" class="btn btn-default btn-sm" title="Kosár ürítése">kosár üritése <i class="fa fa-trash-o"></i></a>
								<? endif; ?>
							</div>
							<? endif; ?>
							<h1>KOSÁR</h1>
            		...
            		<div class="row">
            			<div class="col-sm-6">
            				<script type="text/javascript">
	                            ...
	                            'url': 'https://ecom.cetelem.hu/ecommerce/Calc.action',
	                            'duration': '12'
	                            });
	                            calc.iframe(420, 325);
	                        </script>
