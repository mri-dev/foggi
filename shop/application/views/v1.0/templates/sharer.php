...
<div class="share-box">
  ...
  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-google-plus"></i></a></div>
	<div class="twitter" 	title="Megosztás Twitter-en!"><a href="javascript:void(0);" onclick="window.open('https://twitter.com/intent/tweet?text=<? echo urlencode($this->title.' - ' . $url ); ?>&via=foggidebrecen', '', 'width=800, height=240');"><i class="fa fa-twitter"></i></a></div>
